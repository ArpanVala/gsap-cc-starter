...
const GsapScrollTrigger = () => {
  ...
  return (
    <main>
      ...
      <div className="mt-20 w-full h-screen" ref={boxRef}>
        <div
          id="scroll-pink"
        ...
        />
         <div
          id="scroll-orange"
          className="scroll-box border-white border-2 w-fit h-fit font-bold font-sans rounded-lg text-7xl text-white"
        >HII</div>
      </div>
